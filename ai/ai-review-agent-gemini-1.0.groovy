...
class AiGeminiReviewProvider implements AiReviewProvider {
    ...
    Set<String> getModels(String apiKey) {
        ...
        try {
            httpClient.execute(get).withCloseable {
                int code = it.statusLine.statusCode
                String body = EntityUtils.toString(it.entity, StandardCharsets.UTF_8)
    ...
    String review(String apiKey, String model, String prompt) {
        ...
        try {
            httpClient.execute(post).withCloseable {
                int code = it.statusLine.statusCode
                String body = EntityUtils.toString(it.entity, StandardCharsets.UTF_8)
