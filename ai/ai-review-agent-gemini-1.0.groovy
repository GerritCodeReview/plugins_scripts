...
class AiGeminiReviewProvider implements AiReviewProvider {
    ...
    final Set<String> models = ['gemini-2.5-flash', 'gemini-2.5-flash-lite', 'gemini-2.5-pro'] as Set
...
class GeminiReviewProviderModule extends LifecycleModule {
    @Override
    protected void configure() {
        // Class names drop the '.class' extension in Groovy
...
modules = [ GeminiReviewProviderModule ]